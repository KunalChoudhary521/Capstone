...
namespace EDF
{
  public class EDFHeader
  {
    ...
    private float _DurationOfDataRecordInSeconds = 0;
    public float DurationOfDataRecordInSeconds
    {
      get
      {
    ...
    private void parseHeader(char[] header)
    {
      ...
      this.DurationOfDataRecordInSeconds = float.Parse(new string(durationOfDataRecord).Trim());
